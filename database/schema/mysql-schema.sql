...
This should throw an error to see if the schema is being used
...
CREATE TABLE `additional_columns` (
  ...
  `validations` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  CONSTRAINT `additional_columns_chk_1` CHECK (json_valid(`config`)),
  CONSTRAINT `additional_columns_chk_2` CHECK (json_valid(`validations`)),
  CONSTRAINT `additional_columns_chk_3` CHECK (json_valid(`values`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `address_address_type_order` (
  ...
  CONSTRAINT `address_address_type_order_chk_1` CHECK (json_valid(`address`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `address_sanitizer_geocode_results` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `payload_hash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `address_serial_number`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `address_serial_number` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `address_id` bigint unsigned NOT NULL,
  `serial_number_id` bigint unsigned NOT NULL,
  `quantity` int unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `address_serial_number_address_id_foreign` (`address_id`),
  KEY `address_serial_number_serial_number_id_foreign` (`serial_number_id`),
  CONSTRAINT `address_serial_number_address_id_foreign` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `address_serial_number_serial_number_id_foreign` FOREIGN KEY (`serial_number_id`) REFERENCES `serial_numbers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `address_types` (
  ...
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Uuid of the record.',
  `client_id` bigint unsigned NOT NULL COMMENT 'A unique identifier number for the table clients.',
  `address_type_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Used for special queries or functions, eg. order always need an address with address type ''inv'' ( invoice ).',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `addresses` (
  ...
  `mailbox_city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mailbox_zip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `email_primary` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `calendar_events` (
  ...
  `repeat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `repeat_end` datetime DEFAULT NULL,
  `recurrences` int unsigned DEFAULT NULL,
  `excluded` json DEFAULT NULL,
  `is_all_day` tinyint(1) NOT NULL DEFAULT '0',
  `extended_props` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `calendar_events_model_type_model_id_index` (`model_type`,`model_id`),
  CONSTRAINT `calendar_events_calendar_id_foreign` FOREIGN KEY (`calendar_id`) REFERENCES `calendars` (`id`) ON DELETE CASCADE,
  CONSTRAINT `calendar_events_chk_1` CHECK (json_valid(`extended_props`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `calendar_groups` (
  ...
  `calendarable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `calendarables` (
  ...
  `calendarable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `calendarable_id` bigint unsigned NOT NULL,
  `permission` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'owner',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `calendars` (
  ...
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `calendars_parent_id_foreign` (`parent_id`),
  KEY `calendars_model_type_index` (`model_type`),
  CONSTRAINT `calendars_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `calendars` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cart_items` (
  ...
  KEY `cart_items_order_column_index` (`order_column`),
...
CREATE TABLE `carts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `authenticatable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `client_payment_type` (
  `pivot_id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `client_id` bigint unsigned NOT NULL,
  `payment_type_id` bigint unsigned NOT NULL,
  PRIMARY KEY (`pivot_id`),
  KEY `client_payment_type_client_id_foreign` (`client_id`),
  KEY `client_payment_type_payment_type_id_foreign` (`payment_type_id`),
  CONSTRAINT `client_payment_type_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `client_payment_type_payment_type_id_foreign` FOREIGN KEY (`payment_type_id`) REFERENCES `payment_types` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clients` (
  ...
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` bigint unsigned DEFAULT NULL,
  `commission_credit_note_order_type_id` bigint unsigned DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `client_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ceo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `street` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `creditor_identifier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vat_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sepa_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `opening_hours` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  KEY `clients_commission_credit_note_order_type_id_foreign` (`commission_credit_note_order_type_id`),
  CONSTRAINT `clients_commission_credit_note_order_type_id_foreign` FOREIGN KEY (`commission_credit_note_order_type_id`) REFERENCES `order_types` (`id`) ON DELETE SET NULL,
  CONSTRAINT `clients_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`),
  CONSTRAINT `clients_chk_1` CHECK (json_valid(`opening_hours`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `commissions` (
  ...
  `credit_note_order_position_id` bigint unsigned DEFAULT NULL,
  `commission_rate` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  KEY `commissions_credit_note_order_position_id_foreign` (`credit_note_order_position_id`),
  ...
  CONSTRAINT `commissions_credit_note_order_position_id_foreign` FOREIGN KEY (`credit_note_order_position_id`) REFERENCES `order_positions` (`id`) ON DELETE SET NULL,
  ...
  CONSTRAINT `commissions_chk_1` CHECK (json_valid(`commission_rate`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `communicatable` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `communicatable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `communications` (
  ...
  `to` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `cc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `bcc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `communication_type_enum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `communications_chk_1` CHECK (json_valid(`from`)),
  CONSTRAINT `communications_chk_2` CHECK (json_valid(`to`)),
  CONSTRAINT `communications_chk_3` CHECK (json_valid(`cc`)),
  CONSTRAINT `communications_chk_4` CHECK (json_valid(`bcc`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contacts` (
  ...
  `creditor_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `debtor_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `vat_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vendor_customer_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `handle_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `plesk_server_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `plesk_customer_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  UNIQUE KEY `contacts_handle_id_unique` (`handle_id`),
...
CREATE TABLE `countries` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `iso_alpha2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `iso_alpha3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `iso_numeric` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `is_default` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `datatable_user_settings` (
  ...
  CONSTRAINT `datatable_user_settings_chk_1` CHECK (json_valid(`settings`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `datev_client_setting_vat_rate` (
  ...
  `expense_ledger_account_id` bigint unsigned DEFAULT NULL,
  `expense_posting_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `revenue_posting_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `datev_client_settings` (
  ...
  `export_by_column` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'invoice_date',
...
CREATE TABLE `discounts` (
  ...
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'A 36 character long unique identifier string for a record within the whole application.',
  `model_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `model_id` bigint unsigned NOT NULL,
...
CREATE TABLE `document_types` (
  ...
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `client_id` bigint unsigned NOT NULL,
  `name` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '(DC2Type:json)',
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '(DC2Type:json)',
  `additional_header` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '(DC2Type:json)',
  `additional_footer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '(DC2Type:json)',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of record-creation.',
  `created_by` bigint unsigned DEFAULT NULL COMMENT 'A unique identifier number for the table users of the user that created this record.',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of the last change for this record.',
  ...
  CONSTRAINT `document_types_chk_1` CHECK (json_valid(`name`)),
  CONSTRAINT `document_types_chk_2` CHECK (json_valid(`description`)),
  CONSTRAINT `document_types_chk_3` CHECK (json_valid(`additional_header`)),
  CONSTRAINT `document_types_chk_4` CHECK (json_valid(`additional_footer`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `email_templates` (
  ...
  `from_alias` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `to` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `cc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `bcc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `view_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  CONSTRAINT `email_templates_chk_1` CHECK (json_valid(`to`)),
  CONSTRAINT `email_templates_chk_2` CHECK (json_valid(`cc`)),
  CONSTRAINT `email_templates_chk_3` CHECK (json_valid(`bcc`)),
  CONSTRAINT `email_templates_chk_4` CHECK (json_valid(`view_data`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `emails` (
  ...
  CONSTRAINT `emails_chk_1` CHECK (json_valid(`to`)),
  CONSTRAINT `emails_chk_2` CHECK (json_valid(`cc`)),
  CONSTRAINT `emails_chk_3` CHECK (json_valid(`bcc`)),
  CONSTRAINT `emails_chk_4` CHECK (json_valid(`view_data`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `flux_licenses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `flux_licenses` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` bigint unsigned DEFAULT NULL,
  `envoyer_id` bigint unsigned DEFAULT NULL,
  `forge_server_id` bigint unsigned DEFAULT NULL,
  `forge_site_id` bigint unsigned DEFAULT NULL,
  `forge_database_id` int unsigned DEFAULT NULL,
  `forge_scheduler_id` int unsigned DEFAULT NULL,
  `forge_worker_id` int unsigned DEFAULT NULL,
  `forge_reverb_daemon_id` int unsigned DEFAULT NULL,
  `flare_id` bigint unsigned DEFAULT NULL,
  `repman_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `meilisearch_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reverb_port` int unsigned DEFAULT NULL,
  `reverb_app_secret` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reverb_app_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `additional_env` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `free_accounts` int unsigned NOT NULL DEFAULT '0',
  `min_accounts` int unsigned NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `flux_licenses_order_id_foreign` (`order_id`),
  CONSTRAINT `flux_licenses_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `flux_user_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `flux_user_states` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `flux_license_id` bigint unsigned DEFAULT NULL,
  `active_users` int unsigned NOT NULL DEFAULT '0',
  `users` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `flux_user_states_flux_license_id_foreign` (`flux_license_id`),
  CONSTRAINT `flux_user_states_flux_license_id_foreign` FOREIGN KEY (`flux_license_id`) REFERENCES `flux_licenses` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `form_builder_fields` (
  ...
  CONSTRAINT `form_builder_fields_chk_1` CHECK (json_valid(`options`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `form_builder_forms` (
  ...
  CONSTRAINT `form_builder_forms_chk_1` CHECK (json_valid(`options`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_batchables` (
  `job_batch_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `job_batchable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `languages` (
  ...
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `iso_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `ledger_accounts` (
  ...
  `ledger_account_type_enum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `foreign_uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `extra` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `formatted` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `mail_accounts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `protocol` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'imap',
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `host` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `port` int NOT NULL DEFAULT '993',
  `encryption` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ssl',
  `smtp_mailer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'smtp',
  `smtp_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `notification_settings` (
  ...
  `channel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `channel_value` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `notification_settings_chk_1` CHECK (json_valid(`channel_value`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `order_position_stock_posting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_position_stock_posting` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `order_position_id` bigint unsigned NOT NULL,
  `stock_posting_id` bigint unsigned NOT NULL,
  `reserved_amount` decimal(40,10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `order_position_stock_posting_order_position_id_foreign` (`order_position_id`),
  KEY `order_position_stock_posting_stock_posting_id_foreign` (`stock_posting_id`),
  CONSTRAINT `order_position_stock_posting_order_position_id_foreign` FOREIGN KEY (`order_position_id`) REFERENCES `order_positions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `order_position_stock_posting_stock_posting_id_foreign` FOREIGN KEY (`stock_posting_id`) REFERENCES `stock_postings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_position_task` (
  ...
  `amount` decimal(40,10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `order_positions` (
  ...
  `discount_percentage` decimal(11,10) DEFAULT NULL COMMENT 'A number containing the cached full discount in percent for this order-position.',
  ...
  `ean_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'A number containing the European Article Number for the associated product for this order-position.',
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'A string containing a description for the current order-position. Normally this text contains the associated product-description',
  `name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'A string containing a descriptive name or text for the current order-position. Normally this text is set to the associated product-name',
  `product_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'A string containing the associated product-number.',
  `product_prices` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `sort_number` int unsigned NOT NULL COMMENT 'A number to determine the order-positions position in the order.',
  `slug_position` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `order_positions_chk_1` CHECK (json_valid(`product_prices`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_schedule` (
  ...
  PRIMARY KEY (`pivot_id`),
  KEY `order_schedule_order_id_foreign` (`order_id`),
  KEY `order_schedule_schedule_id_foreign` (`schedule_id`),
  CONSTRAINT `order_schedule_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `order_schedule_schedule_id_foreign` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_types` (
  ...
  `print_layouts` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `post_stock_print_layouts` json DEFAULT NULL,
  `reserve_stock_print_layouts` json DEFAULT NULL,
  `order_type_enum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  ...
  CONSTRAINT `order_types_chk_3` CHECK (json_valid(`print_layouts`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `order_type_id` bigint unsigned NOT NULL,
  `price_list_id` bigint unsigned NOT NULL,
  `unit_price_price_list_id` bigint unsigned DEFAULT NULL COMMENT 'Just for customer frontend purposes, the unit price is replaced with the value from this price_list_id price. This also triggers recalculation of the discount.',
  ...
  `address_invoice` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `address_delivery` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_discount_percent` decimal(40,10) unsigned DEFAULT NULL,
  `header_discount` decimal(40,10) unsigned NOT NULL DEFAULT '0.0000000000',
  ...
  `total_vats` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  `logistic_note` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tracking_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_texts` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  ...
  CONSTRAINT `orders_chk_1` CHECK (json_valid(`address_invoice`)),
  CONSTRAINT `orders_chk_2` CHECK (json_valid(`address_delivery`)),
  CONSTRAINT `orders_chk_3` CHECK (json_valid(`total_vats`)),
  CONSTRAINT `orders_chk_7` CHECK (json_valid(`payment_texts`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_notices` (
  ...
  `payment_type_id` bigint unsigned NOT NULL,
  `document_type_id` bigint unsigned NOT NULL,
  `payment_notice` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '(DC2Type:json)',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of record-creation.',
  `created_by` bigint unsigned DEFAULT NULL COMMENT 'A unique identifier number for the table users of the user that created this record.',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of the last change for this record.',
  `updated_by` bigint unsigned DEFAULT NULL COMMENT 'A unique identifier number for the table users of the user that changed this record last.',
  ...
  CONSTRAINT `payment_notices_chk_1` CHECK (json_valid(`payment_notice`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_reminder_texts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mail_to` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `mail_cc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `mail_subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mail_body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `reminder_subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reminder_body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `payment_reminder_texts_chk_1` CHECK (json_valid(`mail_to`)),
  CONSTRAINT `payment_reminder_texts_chk_2` CHECK (json_valid(`mail_cc`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_runs` (
  ...
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `payment_run_type_enum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `price_lists` (
  ...
  `uuid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'A 36 character long unique identifier string for a record within the whole application.',
  `parent_id` bigint unsigned DEFAULT NULL,
  `name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'A string containing a descriptive name for the current price-list.',
  `price_list_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rounding_method_enum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `rounding_precision` int DEFAULT NULL,
  `rounding_number` int unsigned DEFAULT NULL,
  `rounding_mode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_bundle_product` (
  ...
  `count` decimal(40,10) unsigned NOT NULL DEFAULT '1.0000000000',
  PRIMARY KEY (`id`),
...
CREATE TABLE `product_properties` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `property_type_enum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of record-creation.',
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of the last change for this record.',
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_supplier` (
  ...
  `product_id` bigint unsigned NOT NULL,
  `contact_id` bigint unsigned NOT NULL,
  `manufacturer_product_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `purchase_price` decimal(40,10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `products` (
  ...
  `product_number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `time_unit_enum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `purchase_steps` double(8,2) DEFAULT NULL,
  `min_purchase` double(8,2) DEFAULT NULL,
  `max_purchase` double(8,2) DEFAULT NULL,
  `seo_keywords` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `posting_account` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `warning_stock_amount` double(8,2) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `projects` (
  ...
  `responsible_user_id` bigint unsigned DEFAULT NULL,
  `parent_id` bigint unsigned DEFAULT NULL,
  `project_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `progress` decimal(11,10) unsigned NOT NULL DEFAULT '0.0000000000',
  `time_budget` bigint unsigned DEFAULT NULL COMMENT 'Time budget in minutes.',
  `budget` decimal(40,10) unsigned DEFAULT NULL,
  `total_cost` decimal(40,10) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of record-creation.',
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of the last change for this record.',
...
CREATE TABLE `purchase_invoice_positions` (
  ...
  `vat_rate_id` bigint unsigned DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` decimal(40,10) unsigned NOT NULL DEFAULT '1.0000000000',
  `unit_price` decimal(40,10) unsigned DEFAULT NULL,
  `total_price` decimal(40,10) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `purchase_invoices` (
  ...
  KEY `purchase_invoices_approval_user_id_foreign` (`approval_user_id`),
  CONSTRAINT `purchase_invoices_approval_user_id_foreign` FOREIGN KEY (`approval_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `queue_monitorables` (
  ...
  `queue_monitorable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `queue_monitors` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `job_uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `job_batch_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'running',
  ...
  `accept` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `reject` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `schedules` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cron` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `deleted_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `schedules_chk_1` CHECK (json_valid(`cron`)),
  CONSTRAINT `schedules_chk_2` CHECK (json_valid(`parameters`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sepa_mandates` (
  ...
  `mandate_reference_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `serial_numbers` (
  ...
  `supplier_serial_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of record-creation.',
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of the last change for this record.',
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  CONSTRAINT `settings_chk_1` CHECK (json_valid(`settings`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `snapshots` (
  ...
  CONSTRAINT `snapshots_chk_1` CHECK (json_valid(`snapshot`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock_postings` (
  ...
  `remaining_stock` decimal(40,10) DEFAULT NULL,
  `reserved_stock` decimal(40,10) DEFAULT NULL,
  ...
  KEY `stock_postings_parent_id_foreign` (`parent_id`),
  KEY `stock_postings_order_position_id_foreign` (`order_position_id`),
  KEY `stock_postings_serial_number_id_foreign` (`serial_number_id`),
  CONSTRAINT `stock_postings_order_position_id_foreign` FOREIGN KEY (`order_position_id`) REFERENCES `order_positions` (`id`) ON DELETE SET NULL,
  CONSTRAINT `stock_postings_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `stock_postings` (`id`) ON DELETE SET NULL,
  CONSTRAINT `stock_postings_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `stock_postings_serial_number_id_foreign` FOREIGN KEY (`serial_number_id`) REFERENCES `serial_numbers` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `tags` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `tags_chk_1` CHECK (json_valid(`name`)),
  CONSTRAINT `tags_chk_2` CHECK (json_valid(`slug`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactions` (
  ...
  `amount` decimal(40,10) NOT NULL,
  `purpose` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counterpart_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counterpart_account_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counterpart_iban` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counterpart_bic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `counterpart_bank_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `units` (
  ...
  `abbreviation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of record-creation.',
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'A timestamp reflecting the time of the last change for this record.',
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `contact_id` bigint unsigned DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_3cx_extension` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `widgets` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `widgetable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `widgets_chk_1` CHECK (json_valid(`config`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `work_times` (
  ...
  `trackable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2021_07_15_122950_create_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2021_07_26_094511_create_jobs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2021_07_26_113227_create_project_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2021_07_26_130827_create_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2021_08_04_114403_create_structures_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2021_08_05_130242_create_project_category_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2021_08_05_131337_create_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2021_08_05_131338_create_project_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2021_08_05_131339_create_project_category_template_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2021_08_16_130750_create_model_has_values_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2021_08_19_114927_create_logs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2021_08_20_153643_create_model_has_external_record',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2021_09_02_122630_create_media_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2021_09_29_091911_create_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2021_10_06_113937_change_project_name_and_display_name_to_text_on_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2021_10_10_122945_add_created_by_and_updated_by_to_project_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2021_10_10_130317_add_created_by_and_updated_by_to_project_category_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2021_10_12_000000_create_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2021_10_13_120546_add_user_code_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2021_10_13_144444_create_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2021_10_13_144457_create_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (27,'2021_10_13_153217_refactor_customer_id_to_address_id_on_project_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (28,'2021_10_15_123222_create_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (29,'2021_10_15_125009_add_order_position_id_to_project_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'2021_10_18_171234_make_uuid_unique_on_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'2021_10_19_142100_create_clients_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2021_10_27_124958_add_comment_id_on_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2021_10_27_125451_add_missing_foreign_keys_on_project_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2021_10_27_125509_add_missing_foreign_keys_on_project_category_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2021_10_27_125742_add_index_to_model_on_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2021_10_27_150710_refactor_project_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2021_10_27_152910_create_category_project_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2021_10_27_161308_remove_notes_from_project_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2021_11_02_133213_create_client_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2021_11_02_154232_create_currencies_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2021_11_02_154642_create_languages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2021_11_02_162940_create_countries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2021_11_02_162948_create_country_regions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2021_11_02_165053_update_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2021_11_04_132124_add_country_id_on_clients_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2021_11_10_134101_create_event_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2021_11_12_094418_add_fields_to_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2021_11_17_121820_refactor_event_notifications_table_and_rename_table_to_event_subscriptions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2021_12_02_105616_add_fields_to_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2021_12_02_114732_create_units_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (51,'2021_12_02_115214_create_product_option_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (52,'2021_12_02_120025_create_product_options_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (53,'2021_12_02_122611_create_warehouses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (54,'2021_12_02_122613_create_product_properties_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (55,'2021_12_02_122614_create_vat_rates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (56,'2021_12_02_122615_create_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (57,'2021_12_02_124110_create_address_product_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (58,'2021_12_02_124111_create_product_product_option_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (59,'2021_12_02_124113_create_category_product_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (60,'2021_12_02_124114_create_stock_postings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (61,'2021_12_02_152625_add_iso_on_languages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (62,'2021_12_02_155238_add_fields_to_addresses',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (63,'2021_12_02_173420_add_unique_iso_on_currencies_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (64,'2021_12_02_180218_remove_nullables_on_countries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (65,'2021_12_02_182907_create_contact_bank_connections_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (66,'2021_12_02_184018_create_sepa_mandates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (67,'2021_12_03_104415_refactor_clients_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (68,'2021_12_03_122108_add_unique_user_code_on_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (69,'2021_12_03_122659_create_payment_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (70,'2021_12_03_123913_create_document_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (71,'2021_12_03_125031_create_payment_notices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (72,'2021_12_03_131433_create_snapshots_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (73,'2021_12_03_133346_create_order_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (74,'2021_12_03_133801_create_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (75,'2021_12_03_135435_create_document_generation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (76,'2021_12_03_155121_create_product_product_properties_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (77,'2021_12_07_124605_create_record_histories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (78,'2021_12_09_175411_refactor_countries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (79,'2021_12_13_130126_change_name_to_json_on_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (80,'2021_12_13_130127_change_value_to_json_on_model_has_values_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (81,'2021_12_13_130128_change_name_to_json_on_project_category_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (82,'2021_12_13_130129_change_name_to_json_on_project_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (83,'2021_12_13_130130_change_name_to_json_on_countries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (84,'2021_12_13_130620_change_name_to_json_on_country_regions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (85,'2021_12_13_130716_change_translatable_columns_to_json_on_document_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (86,'2021_12_13_130748_change_name_to_json_on_languages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (87,'2021_12_13_130813_change_translatable_columns_to_json_on_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (88,'2021_12_13_130908_change_name_and_description_to_json_on_order_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (89,'2021_12_13_130958_change_payment_notice_to_json_on_payment_notices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (90,'2021_12_13_131019_change_name_and_description_to_json_on_payment_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (91,'2021_12_22_131825_create_interface_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (92,'2022_01_14_124331_add_payment_type_id_foreign_key_on_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (93,'2022_01_14_124616_add_client_id_foreign_key_on_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (94,'2022_01_17_164444_change_latitude_and_longitude_columns_on_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (95,'2022_01_19_141649_rename_booleans_on_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (96,'2022_02_03_211648_create_print_data_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (97,'2022_02_05_100813_create_presentations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (98,'2022_02_10_095414_remove_request_hash_column_from_print_data',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (99,'2022_02_16_111216_add_commoncolumns_to_print_data_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (100,'2022_02_16_125326_rename_category_id_to_parent_id_on_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (101,'2022_02_16_125402_rename_comment_id_to_parent_id_on_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (102,'2022_02_16_125432_rename_project_id_to_parent_id_on_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (103,'2022_02_22_123829_drop_structures_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (104,'2022_02_24_221803_add_sort_on_print_data_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (105,'2022_03_22_120202_create_ticket_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (106,'2022_03_22_130657_create_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (107,'2022_03_22_135412_create_ticket_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (108,'2022_03_24_115836_create_serial_number_ranges_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (109,'2022_03_24_115934_create_serial_numbers_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (110,'2022_03_25_135832_add_login_credentials_on_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (111,'2022_03_28_104423_create_permission_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (112,'2022_03_28_150203_add_is_locked_to_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (113,'2022_04_04_142444_add_category_id_to_media_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (114,'2022_04_04_160347_add_model_to_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (115,'2022_04_04_160418_drop_is_project_category_from_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (116,'2022_04_20_213346_rename_model_to_model_type_on_categories',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (117,'2022_04_21_114304_add_defaul_value_for_is_main_address_on_addresses',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (118,'2022_04_21_145936_rename_model_to_model_type_on_additional_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (119,'2022_04_21_152208_create_categorizables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (120,'2022_04_21_154749_drop_category_id_on_project_tasks',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (121,'2022_04_21_154950_drop_category_id_on_media',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (122,'2022_04_25_203019_drop_category_project_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (123,'2022_04_26_164214_drop_category_product_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (124,'2022_05_04_150548_drop_project_category_template_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (125,'2022_05_09_103353_add_is_sticky_to_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (126,'2022_05_11_090844_add_fields_to_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (127,'2022_05_11_160548_add_purchase_price_to_stock_postings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (128,'2022_05_25_155629_create_discounts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (129,'2022_05_25_163754_create_price_lists_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (130,'2022_05_25_164401_create_prices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (131,'2022_05_25_165029_add_fields_and_relations_to_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (132,'2022_05_30_094008_create_address_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (133,'2022_05_30_094353_create_address_address_type_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (134,'2022_05_30_102802_create_address_address_type_order_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (135,'2022_05_30_104002_add_client_id_to_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (136,'2022_05_31_111952_create_locks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (137,'2022_06_14_113518_create_email_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (138,'2022_06_14_113533_create_emails_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (139,'2022_08_05_033747_update_price_list_id_foreign_key_on_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (140,'2022_08_08_143407_change_name_to_unique_on_table_interface_users',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (141,'2022_08_10_112125_rename_affix_to_suffix_on_serial_number_ranges',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (142,'2022_08_19_085319_drop_is_locked_on_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (143,'2022_08_21_200551_add_missing_fields_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (144,'2022_08_21_211321_add_columns_to_price_lists_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (145,'2022_08_21_221720_change_columns_on_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (146,'2022_08_22_104642_cleanup_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (147,'2022_08_22_162900_make_address_id_nullable_on_warehouses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (148,'2022_08_25_140352_create_contact_options_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (149,'2022_08_26_111946_add_parent_id_to_media_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (150,'2022_08_29_165548_add_morph_to_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (151,'2022_08_30_090725_add_is_customer_editable_to_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (152,'2022_09_01_131105_create_language_lines_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (153,'2022_09_01_175011_drop_ticket_status_id_on_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (154,'2022_09_01_175344_drop_ticket_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (155,'2022_09_08_090944_add_address_ids_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (156,'2022_09_09_124934_add_currency_id_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (157,'2022_09_09_134725_add_columns_to_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (158,'2022_09_09_201241_rename_vat_rate_on_vat_rates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (159,'2022_09_10_105750_create_tag_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (160,'2022_09_19_091542_change_unit_price_list_id_to_nullable_on_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (161,'2022_09_19_122359_create_calendars_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (162,'2022_09_19_122459_create_calendar_events_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (163,'2022_09_19_122500_create_calendar_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (164,'2022_09_19_122500_create_calendarables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (165,'2022_09_19_122500_create_inviteables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (166,'2022_09_26_090745_add_state_to_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (167,'2022_09_26_093237_create_state_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (168,'2022_09_26_115934_add_states_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (169,'2022_09_27_092115_create_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (170,'2022_09_30_144542_create_ticket_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (171,'2022_09_30_151137_add_model_morph_to_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (172,'2022_09_30_164419_add_model_id_to_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (173,'2022_10_07_150608_create_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (174,'2022_10_11_152120_update_unique_constraint_on_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (175,'2022_10_11_155202_add_model_type_to_ticket_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (176,'2022_10_14_122239_create_notification_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (177,'2022_10_17_092931_add_index_on_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (178,'2022_10_19_083928_add_is_primary_to_contact_options',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (179,'2022_10_19_152650_add_morphs_to_serial_number_ranges_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (180,'2022_10_21_110407_create_activity_log_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (181,'2022_10_25_080839_add_addresses_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (182,'2022_10_25_084355_add_address_to_address_address_type_order_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (183,'2022_10_25_190934_add_client_id_to_uniques_on_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (184,'2022_10_25_192226_add_unique_for_customer_number_creditor_number_on_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (185,'2022_10_26_115420_drop_websockets_statistics_entries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (186,'2022_10_26_115557_drop_record_histories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (187,'2022_10_26_120443_drop_model_has_external_record_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (188,'2022_10_26_133015_create_datatable_user_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (189,'2022_10_26_134905_adjust_multiple_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (190,'2022_10_27_123200_create_meta_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (191,'2022_11_06_194707_add_is_translatable_to_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (192,'2022_11_11_054334_add_ticket_number_to_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (193,'2022_11_18_131915_create_product_bundle_product_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (194,'2022_11_18_143148_add_is_bundle_to_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (195,'2022_11_21_133802_add_is_bundle_position_to_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (196,'2022_11_23_130933_change_count_to_decimal_on_product_bundle_product_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (197,'2022_11_23_132305_create_custom_events_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (198,'2022_12_15_123727_add_expires_at_to_personal_access_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (199,'2023_01_16_160351_add_shipping_cost_fields_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (200,'2023_01_17_102729_add_opening_hours_to_clients_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (201,'2023_01_17_135901_add_is_internal_to_comments',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (202,'2023_01_18_123152_add_authenticatable_to_locks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (203,'2023_01_20_114233_add_key_to_serial_number_ranges_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (204,'2023_01_24_213752_add_is_frontend_visibible_to_additional_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (205,'2023_01_25_130653_add_order_type_enum_to_order_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (206,'2023_01_26_161458_add_totals_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (207,'2023_02_06_125912_rename_contact_bank_connections_to_bank_connections',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (208,'2023_02_06_125913_rename_contact_bank_connection_id_to_bank_connection_id_on_sepa_mandates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (209,'2023_02_06_125914_create_accounts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (210,'2023_02_06_125915_create_transactions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (211,'2023_02_08_141252_add_currency_id_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (212,'2023_02_08_150617_add_is_default_to_currencies_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (213,'2023_02_14_150828_create_model_related_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (214,'2023_02_22_125128_adjust_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (215,'2023_03_30_125128_add_print_layouts_to_order_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (216,'2023_05_05_125128_add_widgets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (217,'2023_05_17_125128_add_is_highlight_to_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (218,'2023_05_22_125128_add_is_active_to_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (219,'2023_06_02_104525_refactor_discounts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (220,'2023_06_02_133919_create_discount_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (221,'2023_06_02_134118_create_discount_discount_group_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (222,'2023_06_02_134603_create_contact_discount_group_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (223,'2023_06_02_142834_create_contact_discount_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (224,'2023_06_05_083457_add_is_default_to_price_lists_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (225,'2023_06_07_101454_add_parent_id_to_price_lists',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (226,'2023_06_14_101454_add_state_to_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (227,'2023_06_14_161454_add_category_id_to_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (228,'2023_06_14_161454_add_state_to_project_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (229,'2023_06_30_161454_remove_category_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (230,'2023_07_26_130933_change_address_delivery_id_nullable_on_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (231,'2023_07_26_141052_create_work_time_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (232,'2023_07_27_125634_create_work_times_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (233,'2023_07_28_090301_create_datev_exports_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (234,'2023_07_28_090311_create_datev_export_lines_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (235,'2023_07_28_131722_create_datev_client_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (236,'2023_07_28_145016_create_datev_client_setting_vat_rates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (237,'2023_08_03_154428_create_category_price_list_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (238,'2023_08_08_090853_add_debtor_number_to_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (239,'2023_08_08_090908_add_is_done_to_logs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (240,'2023_08_08_115621_add_expense_account_number_to_datev_client_setting_vat_rates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (241,'2023_08_15_075359_add_cover_media_id_to_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (242,'2023_08_16_102445_add_export_by_column_to_datev_client_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (243,'2023_08_17_103656_create_ledger_accounts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (244,'2023_08_17_104532_add_ledger_account_id_to_order_positions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (245,'2023_08_17_141838_add_posting_key_to_datev_client_setting_vat_rate_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (246,'2023_08_29_144024_create_product_cross_sellings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (247,'2023_08_29_153011_create_product_cross_selling_product_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (248,'2023_09_24_115947_add_columns_to_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (249,'2023_09_24_120115_add_footer_text_to_vat_rates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (250,'2023_09_25_071112_add_bank_connection_id_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (251,'2023_09_27_104520_add_is_blacklisted_to_datev_export_lines_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (252,'2023_10_06_163527_rename_changed_route_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (253,'2023_10_13_110846_add_parent_id_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (254,'2023_10_16_104509_create_form_builder_forms',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (255,'2023_10_16_115345_create_role_ticket_type_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (256,'2023_10_17_112549_create_form_builder_sections',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (257,'2023_10_17_113020_create_form_builder_fields',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (258,'2023_10_17_113049_create_form_builder_responses',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (259,'2023_10_17_124523_create_form_builder_field_responses',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (260,'2023_10_18_101819_create_commission_rates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (261,'2023_10_18_102308_create_commissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (262,'2023_10_18_102654_create_paid_commissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (263,'2023_10_20_105716_add_agent_id_to_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (264,'2023_10_20_105940_add_agent_id_and_responsible_user_id_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (265,'2023_10_20_110036_create_order_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (266,'2023_10_26_133015_add_is_layout_to_datatable_user_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (267,'2023_11_01_082552_add_cache_key_to_datatable_user_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (268,'2023_11_02_192714_create_push_subscriptions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (269,'2023_11_11_091050_add_name_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (270,'2023_11_11_111050_add_name_to_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (271,'2023_11_13_070701_create_mail_accounts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (272,'2023_11_13_073208_create_mail_folders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (273,'2023_11_13_073534_create_mail_messages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (274,'2023_11_14_102359_create_mailables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (275,'2023_11_14_102905_create_mail_account_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (276,'2023_11_14_203857_change_bank_connections_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (277,'2023_11_14_204030_rename_accounts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (278,'2023_11_15_101915_create_bank_connection_client_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (279,'2023_11_15_102007_drop_fields_from_clients_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (280,'2023_11_15_131003_change_account_id_on_transactions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (281,'2023_11_15_133054_rename_bank_connections_on_sepa_mandates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (282,'2023_11_15_140341_refactor_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (283,'2023_11_23_094503_add_columns_to_work_times_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (284,'2023_11_26_135632_add_address_ids_to_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (285,'2023_11_26_190436_add_booleans_to_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (286,'2023_11_28_120317_refactor_project_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (287,'2023_11_28_124902_create_task_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (288,'2023_11_28_125506_create_order_position_task_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (289,'2023_11_28_135337_add_contact_columns_to_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (290,'2023_11_28_140015_drop_is_primary_on_contact_options_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (291,'2023_11_29_073748_add_on_delete_cascade_to_order_positions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (292,'2023_12_06_130752_drop_print_data_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (293,'2023_12_07_125729_drop_presentations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (294,'2023_12_08_072115_create_schedules_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (295,'2023_12_13_110216_add_mail_columns_to_order_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (296,'2023_12_18_131214_create_favorites_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (297,'2023_12_20_090009_create_job_batches_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (298,'2023_12_20_145514_add_is_default_to_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (299,'2023_12_22_090423_add_terms_and_conditions_to_clients_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (300,'2102_09_06_090103_add_fmrecordid_to_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (301,'2024_01_07_104707_add_is_auto_assign_to_mail_accounts_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (302,'2024_01_07_111301_add_is_active_to_mail_folders',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (303,'2024_01_16_162248_add_is_dark_mode_to_users_and_addresses_tables',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (304,'2024_01_15_133446_add_id_to_product_bundle_product_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (305,'2024_01_16_085808_add_delivery_date_end_and_base_totals_to_orders_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (306,'2024_01_18_182448_add_sepa_columns_to_clients_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (307,'2024_01_18_182644_add_mandate_reference_number_to_sepa_mandates_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (308,'2024_01_16_144927_add_unit_columns_to_products_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (309,'2024_01_17_140634_add_is_billable_to_work_times_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (310,'2024_01_22_124107_rename_and_refactor_mail_messages_table_to_communications_table',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (311,'2024_01_22_124419_rename_and_refactor_mailables_table_to_communicatable_table',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (312,'2024_01_28_155510_add_booleans_to_payment_types_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (313,'2024_01_29_094425_rename_bank_connection_id_on_orders_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (314,'2024_01_29_112218_create_payment_runs_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (315,'2024_01_29_124936_create_order_payment_run_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (316,'2024_01_31_100311_create_payment_reminders_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (317,'2024_01_31_110527_add_payment_reminder_texts_to_payment_types_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (318,'2024_02_07_015353_add_end_columns_to_schedules_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (319,'2024_02_07_115544_create_product_supplier_table',9);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (320,'2024_02_07_120031_drop_columns_from_products_table',9);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (321,'2023_11_20_153207_create_finapi_users_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (322,'2024_02_05_142329_create_purchase_invoices_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (323,'2024_02_09_081749_drop_finapi_users_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (324,'2024_02_09_140651_create_purchase_invoice_positions_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (325,'2024_02_15_141714_add_foreign_key_on_origin_position_id_to_order_positions_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (327,'2024_02_26_130644_update_morph_types_based_on_morph_map',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (328,'2024_03_04_155158_drop_state_settings_table',12);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (329,'2024_03_06_090747_add_system_delivery_date_to_purchase_invoices_table',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (330,'2024_03_06_091108_add_bank_columns_to_orders_table',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (331,'2024_03_06_125026_add_bank_columns_to_users_table',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (332,'2024_03_06_125146_add_bank_columns_to_purchase_invoices_table',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (333,'2024_03_06_135707_add_lay_out_user_id_to_purchase_invoices_table',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (334,'2024_03_07_132542_add_ledger_account_id_to_datev_client_setting_vat_rate_table',14);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (335,'2024_03_07_074735_add_purchase_payment_type_id_to_contacts_table',15);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (336,'2024_03_12_100124_add_is_fibu_transfer_to_datev_client_settings_table',16);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (337,'2024_03_13_083739_create_datev_client_setting_payment_type_table',17);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (338,'2024_03_12_132456_create_payment_reminder_texts_table',18);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (339,'2024_03_12_152551_drop_reminder_texts_from_payment_types_table',18);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (340,'2024_03_14_095724_add_payment_reminder_columns_to_orders_table',18);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (341,'2024_04_25_053928_add_id_to_product_product_option_table',19);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (342,'2024_04_25_082035_create_client_product_table',19);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (343,'2024_04_26_171408_add_model_morph_to_tasks_table',19);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (344,'2024_05_09_191957_remove_unique_login_name_from_addresses_table',20);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (345,'2023_08_14_133924_add_repeatable_calendar_events',21);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (346,'2024_05_13_110905_add_foreign_keys_to_orders_table',21);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (347,'2024_05_15_100520_add_has_repeatable_events_to_calendars_table',21);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (348,'2024_05_16_123152_add_client_id_to_projects_table',21);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (349,'2024_05_25_160920_create_queue_monitor_table',22);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (350,'2024_05_29_165271_create_queue_monitorables_table',22);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (351,'2024_05_29_175541_create_job_batchables_table',22);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (352,'2024_06_05_083023_refactor_datev_client_setting_vat_rate_table',22);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (353,'2024_06_20_165116_add_rounding_columns_to_price_lists_table',23);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (354,'2024_06_30_112522_change_latitude_and_longitude_columns_on_addresses_table',23);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (355,'2024_06_17_140329_create_carts_table',24);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (356,'2024_06_17_140447_create_cart_items_table',24);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (357,'2024_07_10_081037_change_email_columns_on_addresses_table',25);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (358,'2024_07_16_081749_change_transactions_table',26);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (359,'2024_07_17_170226_add_started_at_and_ended_at_to_communications_table',27);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (360,'2024_07_17_181504_add_3cx_extension_to_users_table',27);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (361,'2024_07_22_112004_add_has_formal_salutation_to_addresses_table',28);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (362,'2024_07_23_071048_create_address_sanitizer_geocode_results_table',28);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (363,'2024_07_23_091048_drop_morph_on_address_sanitizer_geocode_results_table',29);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (364,'2024_07_29_092837_add_morph_to_event_subscriptions_table',30);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (365,'2024_07_29_115158_add_booleans_to_mail_folders_table',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (366,'2024_07_29_120146_add_currency_id_to_contacts_table',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (367,'2024_07_31_133409_add_total_purchase_price_to_orders_table',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (368,'2024_08_01_045824_add_is_purchase_to_price_lists_table',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (369,'2024_08_01_062221_add_cost_per_hour_to_users_table',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (370,'2024_08_01_062934_add_total_cost_to_trackable_tables',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (371,'2024_08_06_085418_change_default_is_single_booking_on_payment_runs_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (372,'2024_08_06_085944_add_is_successful_to_order_payment_run_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (373,'2024_08_06_092837_add_soft_deletes_to_transactions_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (374,'2024_08_08_070527_add_vat_id_to_clients_table',33);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (375,'2024_08_08_074612_recalculate_total_vats',33);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (376,'2024_08_08_081423_drop_translatable',33);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (377,'2024_08_06_134434_add_product_type_to_products_table',34);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (378,'2024_08_07_130843_create_product_property_groups_table',34);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (379,'2024_08_07_130909_update_product_properties_table',34);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (380,'2024_08_08_121010_fix_foreign_keys_for_created_by',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (381,'2024_08_21_075922_add_user_modification_columns_to_bank_connections_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (382,'2024_08_21_075922_add_user_modification_columns_to_calendar_events_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (383,'2024_08_21_075922_add_user_modification_columns_to_calendars_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (384,'2024_08_21_075922_add_user_modification_columns_to_communications_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (385,'2024_08_21_075922_add_user_modification_columns_to_discount_groups_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (386,'2024_08_21_075922_add_user_modification_columns_to_mail_accounts_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (387,'2024_08_21_075922_add_user_modification_columns_to_payment_reminders_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (388,'2024_08_21_075922_add_user_modification_columns_to_payment_runs_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (389,'2024_08_21_075922_add_user_modification_columns_to_purchase_invoice_positions_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (390,'2024_08_21_075922_add_user_modification_columns_to_purchase_invoices_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (391,'2024_08_21_075922_add_user_modification_columns_to_transactions_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (392,'2024_08_21_122117_refactor_created_deleted_updated_by_columns',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (393,'2024_06_18_094415_add_order_row_to_widgets_table',36);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (394,'2024_08_23_114601_add_missing_created_updated_deleted_by_columns',37);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (395,'2024_08_23_114848_drop_created_updated_deleted_by_indexes',37);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (396,'2024_08_28_163730_migrate_process_subscription_order_job_to_invokable_class_on_schedules_table',38);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (397,'2024_08_29_121706_create_contact_origins_table',38);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (398,'2024_08_29_124359_add_contact_origin_id_to_contacts_table',38);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (399,'2024_08_26_163302_add_columns_to_stock_postings_table',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (400,'2024_08_26_163326_create_address_serial_number_table',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (401,'2024_09_02_140949_rename_is_required_product_serial_number_to_has_serial_numbers_on_products_table',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (402,'2024_09_02_141810_refactor_serial_numbers_table',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (403,'2024_09_04_141342_add_stock_layouts_to_order_types_table',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (404,'2024_09_04_150022_create_order_position_stock_posting_table',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (406,'2024_10_13_074742_create_flux_licenses_table',40);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (407,'2024_10_13_202211_create_flux_user_states_table',41);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (408,'2024_10_10_090128_add_columns_to_users_table',42);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (409,'2024_10_16_101637_change_column_type_description_on_payment_types_table',43);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (410,'2024_10_16_101647_change_column_type_description_on_order_types_table',43);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (411,'2024_10_16_101932_change_column_type_footer_text_on_vat_rates_table',43);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (412,'2024_09_20_122427_add_columns_to_calendars_table',44);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (413,'2024_09_20_132934_add_model_morph_to_calendar_events_table',44);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (414,'2024_10_20_114910_reverse_sign_for_pause_work_times_on_work_times_table',45);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (415,'2024_10_23_105618_add_is_default_to_vat_rates_table',46);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (416,'2024_10_23_113320_create_client_payment_type_table',46);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (417,'2024_10_23_105628_add_contact_id_to_users_table',47);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (418,'2024_10_23_112452_add_credit_note_order_position_id_to_commissions_table',47);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (419,'2024_10_24_132339_drop_paid_commissions_table',47);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (420,'2024_10_25_053445_create_order_schedule_table',47);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (421,'2024_10_25_125712_add_soft_deletes_to_commissions_table',47);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (422,'2024_11_03_130848_remove_fm_fields',48);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (423,'2024_10_30_090515_add_order_column_to_cart_items_table',49);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (424,'2024_10_30_121218_add_slug_to_order_positions_table',50);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (425,'2024_11_11_202039_add_approval_user_id_to_purchase_invoices_table',51);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (426,'2024_11_13_080919_add_commission_credit_note_order_type_id_to_clients_table',52);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (427,'0001_01_01_000000_create_users_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (428,'0001_01_01_000001_create_cache_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (429,'0001_01_01_000002_create_jobs_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (430,'2023_04_24_000000_create_additional_column_sets_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (431,'2023_04_24_000000_create_shopware_ids_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (432,'2023_07_19_000000_add_auto_increment_to_shopware_ids_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (433,'2023_12_06_162906_create_open_ai_files_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (434,'2023_12_06_172524_create_open_ai_chats_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (435,'2023_12_06_180753_create_open_ai_messages_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (436,'2023_12_07_163545_create_open_ai_assistants_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (437,'2023_12_12_184358_create_open_ai_runs_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (438,'2024_01_08_072113_rename_tables_and_columns',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (439,'2024_04_16_114829_update_morph_types_based_on_morph_map',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (440,'2024_04_22_161313_add_parent_id_to_shopware_ids_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (441,'2024_05_05_110911_add_dto_index_to_shopware_ids_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (442,'2024_05_06_193756_rename_dto_to_entity_on_shopware_ids_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (443,'2024_11_06_065309_add_handle_id_to_contacts_table',53);
