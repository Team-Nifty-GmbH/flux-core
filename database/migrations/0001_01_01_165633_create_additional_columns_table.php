...
return new class() extends Migration
{
    ...
    {
        if (Schema::hasTable('additional_columns')) {
            return;
        }
        ...
        Schema::create('additional_columns', function (Blueprint $table) {
            ...
            $table->boolean('is_customer_editable')->default(false)->comment('If set to true the customer can edit this field in the customer portal.');
