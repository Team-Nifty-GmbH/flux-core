...
return new class extends Migration
{
    ...
    {
        Schema::table('address_address_type', function (Blueprint $table) {
    ...
    {
        Schema::table('address_address_type', function (Blueprint $table) {
            $table->dropForeign('address_address_type_address_id_foreign');
            $table->dropForeign('address_address_type_address_type_id_foreign');
        });
    }
};
