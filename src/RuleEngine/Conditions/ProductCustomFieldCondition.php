...
class ProductCustomFieldCondition implements ConditionInterface
{
    use ComparesValues;
    ...
    {
        if (! $scope instanceof PriceScope || $scope->product === null || $this->field === null) {
            return false;
        }

        $actual = data_get($scope->product, $this->field);
