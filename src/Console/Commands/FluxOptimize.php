...
class FluxOptimize extends Command
{
    ...
    protected function optimizeCommands(): void
    {
        ...
        // Write atomically so a parallel boot never reads a partial file.
        file_put_contents($cachePath . '.tmp', $content);
