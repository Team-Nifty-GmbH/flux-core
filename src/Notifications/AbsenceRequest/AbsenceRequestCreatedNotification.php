...
class AbsenceRequestCreatedNotification extends Notification implements RoutableToastNotification, ShouldQueue
{
    ...
    public function toToastNotification(object $notifiable): ToastNotification
    {
        return ToastNotification::make()
            ...
            ->title(__(':employee filed a new absence request', [
