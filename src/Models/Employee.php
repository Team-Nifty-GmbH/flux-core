...
{
    use CascadeSoftDeletes, Commentable, Communicatable, Filterable, HasAdditionalColumns,
        HasClientAssignment, HasFrontendAttributes, HasPackageFactory, HasUserModification, HasUuid,
    ...
    public function getTotalVacationDays(
        ...
        if ($includeAdjustments) {
            $adjustments = $this->balanceAdjustments()
