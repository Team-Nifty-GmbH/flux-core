...
class Project extends FluxModel implements Calendarable, HasMedia, InteractsWithDataTables
{
    use Commentable, Filterable, HasAdditionalColumns, HasClientAssignment, HasFrontendAttributes,
        HasNotificationSubscriptions, HasPackageFactory, HasParentChildRelations, HasSerialNumberRange, HasStates,
        HasTags, HasUserModification, HasUuid, InteractsWithMedia, LogsActivity, SoftDeletes;
    use Searchable {
