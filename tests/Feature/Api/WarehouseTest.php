...
class WarehouseTest extends BaseSetup
{
    ...
    public function test_get_warehouse_warehouse_not_found()
    {
        $this->user->givePermissionTo($this->permissions['show']);
        Sanctum::actingAs($this->user, ['user']);
    ...
    public function test_update_warehouse_validation_fails()
    {
        $warehouse = [
            'name' => Str::random(),
            'address_id' => $this->addresses[0]->id,
    ...
    public function test_delete_warehouse_warehouse_not_found()
    {
        $this->user->givePermissionTo($this->permissions['delete']);
        Sanctum::actingAs($this->user, ['user']);
