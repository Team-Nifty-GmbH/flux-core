...
class CountryTest extends BaseSetup
{
    ...
    public function test_create_country_iso_alpha2_exists(): void
    {
        $country = [
            'language_id' => $this->language->id,
            'currency_id' => $this->currency->id,
    ...
    public function test_create_country_maximum(): void
    {
        $country = [
            'language_id' => $this->language->id,
            'currency_id' => $this->currency->id,
    ...
    public function test_create_country_validation_fails(): void
    {
        $country = [
    ...
    public function test_delete_country_country_not_found(): void
    {
        $this->user->givePermissionTo($this->permissions['delete']);
        Sanctum::actingAs($this->user, ['user']);
    ...
    public function test_delete_country_country_referenced_by_address(): void
    {
    ...
    public function test_delete_country_country_referenced_by_client(): void
    {
    ...
    public function test_get_country_country_not_found(): void
    {
        $this->user->givePermissionTo($this->permissions['show']);
        Sanctum::actingAs($this->user, ['user']);
    ...
    public function test_update_country_iso_alpha2_exists(): void
    {
        $country = [
            'id' => $this->countries[0]->id,
    ...
    public function test_update_country_maximum(): void
    {
        $country = [
            'id' => $this->countries[0]->id,
            'language_id' => $this->language->id,
    ...
    public function test_update_country_validation_fails(): void
    {
        $country = [
            'id' => $this->countries[0]->id,
            'name' => 42,
