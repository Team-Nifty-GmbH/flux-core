...
class OrderTest extends BaseSetup
{
    ...
    public function test_create_order_with_address_delivery(): void
    {
        $order = [
            'address_invoice_id' => $this->addresses[0]->id,
            'address_delivery_id' => $this->addresses[1]->id,
    ...
    public function test_create_order_with_address_delivery_validation_fails(): void
    {
        $order = [
            'address_invoice_id' => $this->addresses[0]->id,
            'address_delivery_id' => $this->addresses[1]->id,
    ...
    public function test_delete_order_order_is_locked(): void
    {
    ...
    public function test_delete_order_order_not_found(): void
    {
        $this->user->givePermissionTo($this->permissions['delete']);
        Sanctum::actingAs($this->user, ['user']);
    ...
    public function test_get_order_order_not_found(): void
    {
        $this->user->givePermissionTo($this->permissions['show']);
        Sanctum::actingAs($this->user, ['user']);
    ...
    public function test_update_order_address_delivery(): void
    {
        $order = [
            'id' => $this->orders[0]->id,
            'address_delivery' => [
    ...
    public function test_update_order_address_delivery_validation_fails(): void
    {
        $order = [
            'id' => $this->orders[0]->id,
            'address_delivery' => [
    ...
    public function test_update_order_with_additional_columns(): void
    {
