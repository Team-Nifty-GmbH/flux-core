...
class CurrencyTest extends BaseSetup
{
    ...
    public function test_create_currency_iso_exists(): void
    {
        $currency = [
            'name' => 'Currency Name',
    ...
    public function test_create_currency_validation_fails(): void
    {
        $currency = [
            'name' => 42,
            'iso' => 42,
    ...
    public function test_delete_currency_currency_not_found(): void
    {
        $this->user->givePermissionTo($this->permissions['delete']);
        Sanctum::actingAs($this->user, ['user']);
    ...
    public function test_delete_currency_currency_referenced_by_country(): void
    {
    ...
    public function test_get_currency_currency_not_found(): void
    {
        $this->user->givePermissionTo($this->permissions['show']);
        Sanctum::actingAs($this->user, ['user']);
    ...
    public function test_update_currency_iso_exists(): void
    {
        $currency = [
            'id' => $this->currencies[0]->id,
    ...
    public function test_update_currency_maximum(): void
    {
        $currency = [
            'id' => $this->currencies[0]->id,
            'name' => 'Currency Name',
    ...
    public function test_update_currency_validation_fails(): void
    {
        $currency = [
            'id' => $this->currencies[0]->id,
            'name' => 42,
