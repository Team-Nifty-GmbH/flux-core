...
test('approving notifies the requesting employees user', function (): void {
    ...
    Notification::assertSentTo($employeeUser, AbsenceRequestApprovedNotification::class);
});

test('approving skips notification when the employee has no user', function (): void {
    $employee = CreateEmployee::make([
        'firstname' => 'Jane',
        'lastname' => 'Smith',
        'employment_date' => '2020-01-01',
