...
{
    public function test_can_open_work_time_modal_on_start(): void
    {
    ...
    public function test_cant_create_billable_task_time_without_contact(): void
    {
    ...
    public function test_create_task_time(): void
    {
    ...
    public function test_pause_daily_work_time(): void
    {
    ...
    public function test_toggle_daily_work_time(): void
    {
        $component = Livewire::test(WorkTime::class)
            ->call('toggleWorkDay', true)
            ->assertStatus(200)
