...
beforeEach(function (): void {
    ...
    $this->purchaseOrder = packagingOrder($this->order, OrderTypeEnum::Purchase);
    $this->purchaseOrderForm = packagingOrderForm($this->purchaseOrder);
    $this->purchasePosition = packagingPosition(
        $this->purchaseOrder,
        $this->product,
        $this->vatRate,
