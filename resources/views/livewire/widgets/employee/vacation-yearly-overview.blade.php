            ...
            <tr @class([
                ...
                <td class="px-4 py-2 whitespace-nowrap text-right">
                    @if($year['carryover_days'] != '0.0')
                        <span class="font-medium">{{ $year['carryover_days'] }}</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">{{ __('days') }}</span>
                    @else
                ...
                <td class="px-4 py-2 whitespace-nowrap text-right">
                    @if($year['adjustments_days'] != '0.0')
                        <span class="font-medium">{{ $year['adjustments_days'] }}</span>
                        <span class="text-xs text-gray-500 dark:text-gray-400">{{ __('days') }}</span>
                    @else
                        <span class="text-gray-400 dark:text-gray-600">-</span>
                    @endif
                ...
                <td class="px-4 py-2 whitespace-nowrap text-right">
                    <span class="font-semibold text-blue-600 dark:text-blue-400">{{ $year['available_days'] }}</span>
                    <span class="text-xs text-gray-500 dark:text-gray-400">{{ __('days') }}</span>
                </td>
                <td class="px-4 py-2 whitespace-nowrap text-right">
                    <span class="font-medium">{{ $year['requested_days'] }}</span>
                    <span class="text-xs text-gray-500 dark:text-gray-400">{{ __('days') }}</span>
                </td>
                <td class="px-4 py-2 whitespace-nowrap text-right">
