<div>
    <div class="mx-auto max-w-4xl p-5">
        <div>
            <h1 class="mb-4 text-center text-2xl font-bold text-gray-700">
                Congratulations and Thank You for choosing Flux ERP!
            </h1>
            <div class="mb-6">
                ...
                <p class="mt-2 text-gray-600">
                    During the initial setup, essential data is established,
                    which you can modify or augment later in the settings.
                </p>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-gray-600">
                    Be sure to keep your Flux ERP updated to benefit from the
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-gray-600">
                    Your experience with Flux ERP is important to us. We welcome
    ...
    @if ($databaseConnectionSuccessful)
        <div class="mt-5 flex flex-col gap-1.5">
            <x-button
                x-cloak
                x-show="! $wire.requestRefresh"
                loading
                color="indigo"
                wire:click="start(); resetProgress();"
                :text="__('Install')"
            />
            <x-button
                x-cloak
                ...
                loading
                color="indigo"
                wire:click="reload().then(() => window.location.reload(true));"
                :text="__('Reload')"
            />
        </div>
    @else
        <div class="flex flex-col gap-1.5">
            ...
            <x-input
                wire:model="dbForm.database"
                :label="__('Database Name')"
            />
            <x-input
                wire:model="dbForm.username"
                :label="__('Database Username')"
            />
            <x-input
                wire:model="dbForm.password"
            ...
            <x-button
                ...
                loading
                :text="__('Test Database Connection')"
            />
        </div>
    @endif
</div>
        ...
        <div class="mb-1 flex items-center justify-between">
            <div class="flex items-center gap-1.5">
                <span
                    ...
                    x-text="progress.title"
                ></span>
                <div
                    role="status"
                    x-cloak
                    x-show="progress.started && progress.progress < 100"
                >
                    <svg
                        aria-hidden="true"
