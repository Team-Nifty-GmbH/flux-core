...
/>
<x-input
    wire:model="clientForm.client_code"
    placeholder="e.g. TN"
    :label="__('Client Code')"
/>
<x-input
    wire:model="clientForm.ceo"
    placeholder="e.g. John Doe…"
    :label="__('CEO')"
/>
<x-input
    wire:model="clientForm.street"
    placeholder="e.g. Example street 1…"
    :label="__('Street')"
/>
<x-input
    wire:model="clientForm.city"
    placeholder="e.g. New York…"
    :label="__('City')"
/>
<x-input
    wire:model="clientForm.postcode"
    placeholder="e.g. 10017…"
    :label="__('Zip')"
/>
<x-input
    wire:model="clientForm.phone"
