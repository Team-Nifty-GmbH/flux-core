<x-modal id="create-stock-posting-modal">
    ...
    <x-slot:footer>
        ...
        <x-button
            ...
            :text="__('Save')"
<<<<<<< HEAD
            wire:click="save().then((success) => { if(success) $tsui.close.modal('create-stock-posting-modal')})"
=======
            x-on:click="$wire.save().then((success) => { if(success) $modalClose('create-stock-posting-modal')})"
