                ...
                @section('basic-info')
                    ...
                    >
                        <div class="flex-1">
                            <x-select.styled
                                x-on:select="
                                    $wire.fillFromSelectedContact(
                                        $event.detail.select?.contact?.id,
                                    )
                                "
                                x-bind:readonly="
                                    $wire.purchaseInvoiceForm.order_id
                            ...
                            <div class="grid grid-cols-2 gap-4 pt-2 pb-2">
                                <div class="col-span-2">
                                    <x-select.styled
                                        ...
                                        x-on:select="
                                            $wire.purchaseInvoiceForm.iban =
                                                $event.detail.select?.iban;
                                            $wire.purchaseInvoiceForm.bic =
                                                $event.detail.select?.bic;
                                            $wire.purchaseInvoiceForm.bank_name =
                                                $event.detail.select?.bank_name;
                                            $wire.purchaseInvoiceForm.account_holder =
                                                $event.detail.select?.account_holder;
                                        "
                                    ...
                                    >
                                        ...
                                        @canAction(\FluxErp\Actions\PurchaseInvoicePosition\DeletePurchaseInvoicePosition::class)
                                            <x-button
                                                ...
                                                sm
                                                x-on:click="
                                                    $wire.purchaseInvoiceForm.purchase_invoice_positions.splice(
                                                        index,
                                                        1,
                                                    )
                                                "
                        ...
                        <div class="flex justify-center pt-4">
                            @canAction(\FluxErp\Actions\PurchaseInvoicePosition\CreatePurchaseInvoicePosition::class)
                                <x-button
                                    ...
                                    x-on:click="
                                        $wire.purchaseInvoiceForm.purchase_invoice_positions.push(
                                            {
                                                ledger_account_id:
                                                    $wire.purchaseInvoiceForm
                                                        .lastLedgerAccountId,
