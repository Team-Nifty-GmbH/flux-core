<x-modal id="edit-ledger-account-modal" :title="__('Ledger Account')">
    ...
    <x-slot:footer>
        <x-button
            ...
            flat
            :text="__('Cancel')"
            x-on:click="$tsui.close.modal('edit-ledger-account-modal')"
        />
        <x-button
            color="indigo"
            :text="__('Save')"
<<<<<<< HEAD
            wire:click="save().then((success) => { if(success) $tsui.close.modal('edit-ledger-account-modal')})"
=======
            x-on:click="$wire.save().then((success) => { if(success) $modalClose('edit-ledger-account-modal')})"
