<x-modal id="edit-serial-number-range-modal">
    <div class="flex flex-col gap-1.5">
        <div class="flex flex-col gap-1.5" x-cloak x-show="! $wire.serialNumberRange.id">
            <x-select.styled
        ...
        <div x-show="$wire.serialNumberRange.id" x-cloak>
            <x-number step="1" min="0" wire:model.number="serialNumberRange.current_number" :label="__('Current Number')" />
        </div>
