        ...
        >
            ...
            <div class="grid grid-cols-1 gap-1 text-xs">
                <div class="flex items-center gap-2">
                    <code
                        class="rounded bg-gray-200 px-1.5 py-0.5 font-mono text-gray-800 dark:bg-gray-700 dark:text-gray-200"
                    >
                        :current_day
                    </code>
                    <span class="text-gray-600 dark:text-gray-400">
                        {{ __('Current day (e.g. :example)', ['example' => date('d')]) }}
                    </span>
                </div>
                <div class="flex items-center gap-2">
                    <code
                    ...
                    <span class="text-gray-600 dark:text-gray-400">
                        {{ __('Current week (e.g. :example)', ['example' => date('W')]) }}
                    </span>
                </div>
                <div class="flex items-center gap-2">
                    <code
                    ...
                    <span class="text-gray-600 dark:text-gray-400">
                        {{ __('Current month (e.g. :example)', ['example' => date('m')]) }}
                    </span>
                </div>
                <div class="flex items-center gap-2">
                    <code
                    ...
                    <span class="text-gray-600 dark:text-gray-400">
                        {{ __('Current quarter (e.g. :example)', ['example' => ceil(date('n') / 3)]) }}
                    </span>
                </div>
                <div class="flex items-center gap-2">
                    <code
                    ...
                    <span class="text-gray-600 dark:text-gray-400">
                        {{ __('Current year (e.g. :example)', ['example' => date('Y')]) }}
                    </span>
                </div>
                <div class="flex items-center gap-2">
                    <code
                    ...
                    <span class="text-gray-600 dark:text-gray-400">
                        {{ __('Current year short (e.g. :example)', ['example' => date('y')]) }}
                    </span>
                </div>
            </div>
        </div>
