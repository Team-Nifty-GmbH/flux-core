<x-modal id="edit-product-property-group-modal" :title="__('Edit Product Property Group')">
        ...
        <template x-for="(property, index) in $wire.productPropertyGroup.product_properties">
            <div class="grid grid-cols-6 space-x-2">
                ...
                <div class="col-span-1 flex justify-end">
                    <x-button color="red" icon="trash" x-on:click="$wire.productPropertyGroup.product_properties.splice(index, 1)" />
                </div>
            </div>
        </template>
