<x-modal id="edit-product-option-group-modal" :title="__('Edit Product Option Group')">
    <div class="flex flex-col gap-1.5">
        ...
        <template x-for="(option, index) in $wire.productOptionGroupForm.product_options">
            <div class="flex gap-1.5">
                ...
                <x-button color="red" icon="trash" x-on:click="$wire.productOptionGroupForm.product_options.splice(index, 1)" />
            </div>
        </template>
