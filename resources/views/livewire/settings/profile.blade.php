                    ...
                    <div class="space-y-4">
                        ...
                        >
                            ...
                            <x-flux::table>
                                ...
                                <template
                                    x-for="
                                        subscription in $wire.pushSubscriptions
                                    "
                                >
                                    <tr
                                        ...
                                        x-init="
                                            $nextTick(async () => {
                                                if (window.webPush) {
                                                    isCurrentBrowser =
                                                        await window.webPush.checkCurrentSubscription(
                        ...
                        <div
                            x-show="
                                webPushSupport.allSupported &&
                                !($wire.pushSubscriptions?.length ?? []) > 0
                            "
                            x-cloak
                        >
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-flux::table>
                                ...
                                <template
                                    x-for="device in $wire.fcmDeviceTokens"
                                >
                                    <tr>
                                        <td>
                                            <div class="flex items-center">
        ...
        @section ('profile.notifications')
            <x-flux::table>
                ...
                <x-slot:header>
                    ...
                    <template
                        x-for="
                            (notificationChannel, name) in
                            $wire.notificationChannels
                        "
                    >
                        <th class="text-left">
                            <div x-text="name" />
                ...
                <template
                    x-for="
                        (notification, notificationName) in
                        $wire.notificationSettings
                    "
                >
                    <tr>
                        <td class="text-center">
                            <div
                                x-text="$wire.notifications[notificationName]"
                            />
                        </td>
                        <template
