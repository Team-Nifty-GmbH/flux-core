    ...
    >
        ...
        <x-slot:footer>
            <x-button
                ...
                color="secondary"
                flat
                x-on:click="$tsui.close.modal('{{ $absencePolicyForm->modalName() }}')"
            />
            <x-button
                :text="__('Save')"
                color="primary"
<<<<<<< HEAD
                wire:click="save().then((success) => { if(success) $tsui.close.modal('{{ $absencePolicyForm->modalName() }}') })"
=======
                x-on:click="$wire.save().then((success) => { if(success) $modalClose('{{ $absencePolicyForm->modalName() }}') })"
