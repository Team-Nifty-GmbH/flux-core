    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold">{{ __('Email Templates') }}</h1>
                <div class="mt-2 text-sm text-gray-300">{{ __('A list of all the users in your account including their name,
                            ...
                            @foreach($emailTemplates as $emailTemplate)
                                <tr class="divide-x divide-gray-200">
                                    ...
                                    <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                                        {{ implode(" ", $emailTemplate['to']) }}
                                    </td>
                                    <td class="whitespace-nowrap py-2 pl-2 pr-2 text-center text-sm text-gray-500">
                                        <button wire:click="showEditModal({{ $emailTemplate['id'] }})" type="button"
    ...
    <x-modal.card :title="__('Edit Template')" blur wire:model.defer="editModal">
        ...
        <x-slot name="footer">
            <div class="flex justify-between gap-x-4">
                <div class="@if($selectedEmailTemplate['id'] ?? true) invisible @endif">
