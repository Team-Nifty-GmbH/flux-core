<x-modal id="edit-schedule-modal" :title="__('Schedule')">
    ...
    <x-slot:footer>
        ...
        <x-button
            ...
            :text="__('Save')"
<<<<<<< HEAD
            wire:click="save().then((success) => { if(success) $tsui.close.modal('edit-schedule-modal')})"
=======
            x-on:click="$wire.save().then((success) => { if(success) $modalClose('edit-schedule-modal')})"
