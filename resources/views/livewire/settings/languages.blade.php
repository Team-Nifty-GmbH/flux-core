<x-modal id="edit-language-modal" wire="editModal" :title="__('Language')">
    ...
    <x-slot:footer>
        <x-button
            ...
            flat
            :text="__('Cancel')"
            x-on:click="$tsui.close.modal('edit-language-modal')"
        />
        <x-button
            color="indigo"
            :text="__('Save')"
<<<<<<< HEAD
            wire:click="save().then((success) => {if(success) $tsui.close.modal('edit-language-modal');});"
=======
            x-on:click="$wire.save().then((success) => {if(success) $modalClose('edit-language-modal');});"
