...
@section("state-card")
    <x-card>
        <div class="space-y-3">
            ...
            />
            <x-checkbox
                wire:model.live="order.is_confirmed"
                :label="__('Confirmed')"
                :disabled="auth()->user()?->id !== $order->approval_user_id"
            />
            <x-number
                min="1"
                step="1"
                wire:model="order.payment_target"
            ...
            <x-number
                min="1"
                step="1"
                wire:model="order.payment_discount_target"
            ...
            <x-number
                ...
                min="0.01"
                max="99.99"
                wire:model="order.payment_discount_percent"
