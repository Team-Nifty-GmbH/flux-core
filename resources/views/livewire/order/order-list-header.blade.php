<div wire:ignore>
    <x-modal
        ...
        x-on:close="
            $wire.discount = null;
            $wire.discountIsPercentage = true;
        "
        x-on:keyup.enter="
            $wire.discountSelectedPositions().then(() => {
                close();
            })
        "
        x-trap="show"
    ...
    >
        ...
        <x-slot:footer>
            ...
            <x-button
                ...
                x-on:click="
                    $wire.discountSelectedPositions().then(() => {
                        $tsui.close.modal('edit-position-discount');
                    })
                "
            />
        </x-slot:footer>
                            ...
                            @section ('order-position-detail-modal.content.left')
                                <div class="flex items-center gap-4">
                                    ...
                                    <div
                                        x-cloak
                                        x-show="
                                            $wire.orderPosition.is_free_text !==
                                            true
                                        "
                                    >
                                        <x-checkbox
                                ...
                                <div
                                    x-cloak
                                    x-show="
                                        $wire.orderPosition.is_bundle_parent
                                    "
                                >
                                    <x-input
                                        type="number"
                        ...
                        <div
                            ...
                            x-data="{
                                ...
                                get basePrice() {
                                    return (
                                        (parseFloat(
                                            $wire.orderPosition.amount,
                                        ) || 0) *
                                        (parseFloat(
                                            $wire.orderPosition.unit_price,
                                        ) || 0)
                                    );
                                },
                                get discountAmount() {
                                    ...
                                    return (
                                        parseFloat(
                                            $wire.orderPosition.discount_flat,
                                        ) || 0
                                    );
                                },
                                get totalPrice() {
                                                        ...
                                                        const percentage =
                                                            basePrice > 0
                                                                ? ((parseFloat(
                                                                  ...
                                                                  100
                                                                : 0;
                                                        $wire.orderPosition.discount_percentage =
                                                            parseFloat(
                                                                percentage.toFixed(
                                                                    9,
                                                                ),
            ...
            <div class="flex justify-between gap-x-4">
                <div x-show="$wire.orderPosition.id">
                    <x-button
                        ...
                        :text="__('Delete')"
                        x-on:click="
                            $wire.deleteOrderPosition().then((success) => {
                                if (success)
                ...
                <div class="flex w-full justify-end gap-x-2">
                    ...
                    <x-button
                        color="indigo"
                        x-on:click="
                            $wire.addOrderPosition().then((success) => {
                                if (success)
                                    $tsui.close.modal('edit-order-position');
                            })
                        "
