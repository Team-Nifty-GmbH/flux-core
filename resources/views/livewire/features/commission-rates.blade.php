    ...
    >
        ...
        <x-slot:footer>
            <x-button
                ...
                flat
                :text="__('Cancel')"
                x-on:click="$tsui.close.modal('{{ $commissionRate->modalName() }}')"
            />
            <x-button
                color="indigo"
                :text="__('Save')"
<<<<<<< HEAD
                wire:click="save().then((success) => { if(success) $tsui.close.modal('{{ $commissionRate->modalName() }}')})"
=======
                x-on:click="$wire.save().then((success) => { if(success) $modalClose('{{ $commissionRate->modalName() }}')})"
