<div
    x-data="{
        addToast(event) {
            Alpine.$data($el.querySelector('#toasts').querySelector('[x-data]')).add(event);
        },
        removeAll() {
            Alpine.$data($el.querySelector('#toasts').querySelector('[x-data]')).toasts = [];
        }
    }"
...
>
    <div>
        ...
        <x-slide id="notifications-slide" scope="notifications" x-on:close="$wire.closeNotifications()">
