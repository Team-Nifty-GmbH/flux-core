    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <x-card :header="__('Time Breakdown')">
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    <span class="text-sm">{{ __('Work Hours') }}</span>
                ...
                <div class="flex justify-between items-center">
                    <span class="text-sm">{{ __('Plus Minus Absence Hours') }}</span>
                ...
                <div class="flex justify-between items-center">
                    <span class="text-sm">{{ __('Vacation Hours Used') }}</span>
                    <span class="font-medium text-red-600 dark:text-red-400">
                ...
                <div class="flex justify-between items-center">
                    <span class="text-sm">{{ __('Plus Minus Overtime Hours') }}</span>
                    <span class="text-2xl font-bold {{ bccomp(data_get($this->employeeDayForm, 'plus_minus_overtime_hours', 0), 0) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
