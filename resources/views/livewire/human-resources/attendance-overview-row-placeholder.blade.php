<tr
    ...
    class="animate-pulse"
>
    <td class="border-r border-b px-4 py-2 dark:border-gray-700">
        <div class="h-4 w-32 rounded bg-gray-200 dark:bg-gray-700"></div>
    </td>
    <td
        class="border-r border-b bg-blue-50/50 px-2 py-2 dark:border-gray-700 dark:bg-blue-900/20"
    >
        <div class="mx-auto h-4 w-8 rounded bg-gray-200 dark:bg-gray-700"></div>
    </td>
    <td
        class="border-r border-b bg-purple-50/50 px-2 py-2 dark:border-gray-700 dark:bg-purple-900/20"
    >
        <div
