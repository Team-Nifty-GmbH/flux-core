...
<style>
    .presentation-3 .presentation-bar{
        width: fit-content;
    ...
    .presentation-3 .presentation-bar:focus-visible{
        outline: none;
    }

    .presentation-3 .presentation-header{
        font-size: 3rem;
        color: black;
        text-align: left;
        width: 100%;
    ...
    .presentation-3 .presentation-header:focus-visible{
        outline: none;
    }

    .presentation-3 .presentation-text-field{
        width: 100%;
        font-size: 1.5rem;
        overflow-y: hidden;
        height: auto;
    ...
    .presentation-3 .presentation-text-field-container{
        height:100%;
        width:50%;
        padding-left:2rem;
        padding-right:2rem;
    ...
    .presentation-3 .presentation-text-field:focus-visible{
        outline: none;
    }

    .presentation-3 .presentation-left-side{
        position: relative;
        width:50%;
        height:100%;
    }

    .presentation-3 .presentation-miscellaneous-logo{
        position: absolute;
        right:2rem;
        bottom: 2rem;
    }
    .presentation-3 .presentation-miscellaneous-company{
        position: absolute;
        left: 2rem;
        bottom: 2rem;
    }

    .presentation-3 .presentation-image{
        position: relative;
        top:0;
        left:0;
        max-width:100%;
    ...
    .presentation-3 .presentation-image-headers{
        position: absolute;
        right:0;
        top: 65%;
        display: flex;
    ...
    .presentation-3 .presentation-image-header{
        margin-bottom: 1rem;
        background-color: #FFFFFF ;
        height: 3rem;
        min-width: 0;
    ...
    .presentation-3 .presentation-image-header:focus-visible{
        outline: none;
    }
    .presentation-3 .presentation-image-container{
        width:100%;
        height:100%;
        display: flex;
    ...
    .presentation-3 .presentation-image-fallback-add { display: none}
    @page  {
        size: A4 landscape;
        margin: 0;
    }
</style>
<div class="presentation-3 presentation-main {{ now() }}">
