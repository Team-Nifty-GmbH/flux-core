...
<style>
    .presentation-5 .presentation-bar{
        width: fit-content;
    ...
    .presentation-5 .presentation-bar:focus-visible{
        outline: none;
    }

    .presentation-5 .presentation-header{
        font-size: 3rem;
        color: black;
        text-align: left;
        width: 100%;
    ...
    .presentation-5 .presentation-header:focus-visible{
        outline: none;
    }

    .presentation-5 .presentation-text-field{
        width: 100%;
        font-size: 1.5rem;
        overflow-y: hidden;
        height: auto;
    ...
    .presentation-5 .presentation-text-field-container{
        height:100%;
        width:50%;
        padding-left:2rem;
        padding-right:2rem;
    ...
    .presentation-5 .presentation-text-field:focus-visible{
        outline: none;
    }

    .presentation-5 .presentation-left-side{
        position: relative;
        width:50%;
        height:100%;
    }

    .presentation-5 .presentation-miscellaneous-logo{
        position: absolute;
        right:2rem;
        bottom: 2rem;
    }
    .presentation-5 .presentation-miscellaneous-company{
        position: absolute;
        left: 2rem;
        bottom: 2rem;
    }

    .presentation-5 .presentation-image{
        position: relative;
        top:0;
        left:0;
        max-width:100%;
    ...
    .presentation-5 .presentation-image-headers{
        position: absolute;
        right:0;
        top: 65%;
        display: flex;
    ...
    .presentation-5 .presentation-image-header{
        margin-bottom: 1rem;
        background-color: #FFFFFF ;
        height: 3rem;
        min-width: 0;
    ...
    .presentation-5 .presentation-image-header:focus-visible{
        outline: none;
    }
    .presentation-5 .presentation-image-container{
        width:100%;
        height:33.3%;
        display: flex;
    ...
    .presentation-5 .presentation-image-fallback-add { display: none}
    @page  {
        size: A4 landscape;
        margin: 0;
    }
</style>
<div class="presentation-5 presentation-main {{ now() }}">
    <div class="presentation-left-side">
        ...
        <div class="presentation-image-container" id="presentation-img-2">
            {!! $presentation_img_2 ??  '<img jsonkey="presentation_img_2" class="presentation-image" src="https://g1.img-dpreview.com/3ACBE6D011274856888F900E563D7A85.jpg"/>' !!}
            <div class="presentation-image-fallback-add">Add Img on right click</div>
        </div>
        <div class="presentation-image-container" id="presentation-img-3">
            {!! $presentation_img_3 ??  '<img jsonkey="presentation_img_3" class="presentation-image" src="https://g1.img-dpreview.com/3ACBE6D011274856888F900E563D7A85.jpg"/>' !!}
            <div class="presentation-image-fallback-add">Add Img on right click</div>
        </div>
