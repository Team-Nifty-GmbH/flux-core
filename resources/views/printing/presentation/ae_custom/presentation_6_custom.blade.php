...
<style>
    .presentation-6 .presentation-miscellaneous-logo{
        position: absolute;
        right:2rem;
        bottom: 2rem;
    }
    .presentation-6 .presentation-miscellaneous-company{
        position: absolute;
        left: 2rem;
        bottom: 2rem;
    }

    .presentation-6 .presentation-image{
        position: relative;
        top:0;
        left:0;
        max-width:100%;
    ...
    .presentation-6 .presentation-image-container{
        flex-grow:1;
        height:100%;
        width:33.3%;
        display: flex;
    ...
    .presentation-6 .presentation-image-fallback-add { display: none}
    @page  {
        size: A4 landscape;
        margin: 0;
    }
</style>
<div class="presentation-6 presentation-main {{ now() }}">
