<div
    ...
    x-on:mousemove.window="
        ...
        ! firstPageHeaderStore.isResizeOrScaleActive
            ? firstPageHeaderStore.onMouseMove($event)
            : null
    "
    class="relative box-border w-full"
    x-bindx-bind:class="{ 'z-[100]': firstPageHeaderStore.snippetEditorXData !== null }"
>
    ...
    <div
        x-cloak
        x-show="firstPageHeaderStore.selectedElementId !== null && !firstPageHeaderStore.isImgResizeClicked"
        x-bind:style="{
            'transform': `translate(${firstPageHeaderStore.selectedElementPos.x - 50}px,${firstPageHeaderStore.selectedElementPos.y}px)`,
        }"
        class="absolute left-0 top-0 z-[100] rounded bg-gray-100 p-2 shadow"
    >
        <div
            x-text="`${roundToOneDecimal(firstPageHeaderStore.selectedElementPos.x / firstPageHeaderStore.pxPerCm)}cm`"
        ></div>
    </div>
    <div
        x-cloak
        x-show="firstPageHeaderStore.selectedElementId !== null && !firstPageHeaderStore.isImgResizeClicked"
        x-bind:style="{
            'transform': `translate(${firstPageHeaderStore.selectedElementPos.x}px,${firstPageHeaderStore.selectedElementPos.y - 40}px)`,
        }"
        class="absolute left-0 top-0 z-[100] rounded bg-gray-100 p-2 shadow"
    >
        <div
            x-text="`${roundToOneDecimal(firstPageHeaderStore.selectedElementPos.y / firstPageHeaderStore.pyPerCm)}cm`"
        ></div>
    </div>
    {{-- UI position of a selected element --}}
    ...
    <div
        x-cloak
        x-show="firstPageHeaderStore.isSnippetResizeClicked && firstPageHeaderStore.selectedElementId !== null"
        x-bind:style="{
            'transform': `translate(${firstPageHeaderStore.selectedElementPos.x - 50}px,${firstPageHeaderStore.selectedElementPos.y}px)`,
        }"
        class="absolute left-0 top-0 z-[100] rounded bg-gray-100 p-2 shadow"
    >
        <div
            x-text="`h:${roundToOneDecimal(firstPageHeaderStore.selectedElementSize.height / firstPageHeaderStore.pxPerCm)}cm`"
        ></div>
    </div>
    <div
        x-cloak
    ...
    >
        <div
            x-text="`w: ${roundToOneDecimal(firstPageHeaderStore.selectedElementSize.width / firstPageHeaderStore.pyPerCm)}cm`"
        ></div>
    </div>
    {{-- UI size of a snippet --}}
    {{-- UI snippet box name --}}
    <template
        x-for="(box, index) in firstPageHeaderStore.snippetNames"
    ...
    <div
        ...
        class="box-border h-[7cm] text-2xs leading-3"
        x-bind:style="`height: ${firstPageHeaderStore.height};`"
    >
        <div
            x-on:mousemove.window="
                firstPageHeaderStore.isImgResizeClicked
                    ? firstPageHeaderStore.onMouseMoveScale($event)
                    : firstPageHeaderStore.isSnippetResizeClicked
                      ? firstPageHeaderStore.onMouseMoveResize($event)
                      : null
            "
            class="h-0 w-0"
        ></div>
    </div>
    <template id="{{ $client->id }}" x-ref="first-page-header-client-name">
        <div
            ...
            x-on:mousedown="
                printStore.editFirstPageHeader
                    ? firstPageHeaderStore.onMouseDown($event, 'first-page-header-client-name')
                    : null
            "
        >
    ...
    >
        <div
            ...
            data-type="container"
            draggable="false"
            class="absolute left-0 top-0 w-fit select-none text-2xs"
            x-bind:class="{
                'bg-gray-300':
                    firstPageHeaderStore.selectedElementId ===
    ...
    >
        <div
            ...
            x-bind:class="{
                'bg-gray-300':
                    firstPageHeaderStore.selectedElementId === 'first-page-header-subject',
            }"
            x-on:mousedown="
                printStore.editFirstPageHeader
                    ? firstPageHeaderStore.onMouseDown($event, 'first-page-header-subject')
                    : null
            "
        >
    ...
    <template id="{{ uniqid() }}" x-ref="first-page-header-additional-img">
        <div
            ...
            x-on:mousedown="
                printStore.editFirstPageHeader
                    ? firstPageHeaderStore.onMouseDown($event, $el.id, 'temporary')
                    : null
            "
            data-type="resizable"
            draggable="false"
    ...
    <template id="{{ uniqid() }}" x-ref="first-page-header-media">
        <div
            id="first-page-header-media"
            x-on:mousedown="
                printStore.editFirstPageHeader
                    ? firstPageHeaderStore.onMouseDown($event, $el.id, 'media')
                    : null
            "
            data-type="resizable"
            draggable="false"
    ...
    <template id="{{ uniqid() }}" x-ref="first-page-header-additional-snippet">
        <div
            ...
            x-on:mousedown="
                ...
                firstPageHeaderStore.snippetEditorXData === null
                    ? firstPageHeaderStore.onMouseDown($event, $el.id, 'temporary-snippet')
                    : null
            "
            id="first-page-header-snippet-placeholder"
            data-type="resizable"
            draggable="false"
            class="absolute h-[1.7cm] w-[10cm] border text-2xs"
            x-bind:class="{
                ...
                'z-[-10]':
                    firstPageHeaderStore.snippetEditorXData !== null &&
                    firstPageHeaderStore.snippetEditorXData?.elementObj.id !== objId,
            }"
        >
            <div
                draggable="false"
            ...
            >
                ...
                ></x-icon>
                <template
                    x-if="firstPageHeaderStore.snippetEditorXData?.elementObj.id === objId"
                >
                    <x-flux::editor
    ...
    <template id="{{ uniqid() }}" x-ref="first-page-header-snippet">
        <div
            ...
            x-on:mousedown="
                printStore.editFirstPageHeader &&
                firstPageHeaderStore.snippetEditorXData === null
                    ? firstPageHeaderStore.onMouseDown($event, $el.id, 'snippet')
                    : null
            "
            data-type="resizable"
            draggable="false"
