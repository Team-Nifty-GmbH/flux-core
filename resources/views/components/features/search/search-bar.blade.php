<div x-data="{ show: @entangle('show').live }">
    ...
    >
        <x-input
            ...
            placeholder="{{ __('Enter a search phrase…') }}"
            wire:model.live="search"
        />
        <div></div>
        <div
            class="relative z-10 w-full flex-col rounded-md border bg-white pt-3 shadow-2xl"
            x-show="show"
            x-transition
            x-cloak
        >
            <div wire:loading.class="opacity-60" x-on:click="show = false">
                ...
                <div
                    class="flex w-full items-center justify-center pb-3 text-gray-500"
                    x-show="!results"
                >
