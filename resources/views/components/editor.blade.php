...
<div>
    ...
    <div
        ...
        x-init="initTextArea($refs.editor)"
        {{ $attributes->whereDoesntStartWith('wire:model') }}
        wire:ignore
    >
        <template x-ref="popWindow" id="pop-up" class="divide-x flex flex-wrap items-stretch placeholder-secondary-400 dark:bg-secondary-800 dark:text-secondary-400 dark:placeholder-secondary-500 border border-b-0 border-secondary-300 focus:ring-primary-500 focus:border-primary-500 dark:border-secondary-600  w-full sm:text-sm rounded-t-md transition ease-in-out duration-100 focus:outline-none">
            @if($bold)
...
{{--        <div x-cloak x-transition x-show="proxy.isEditable"--}}
...
{{--            @endif--}}
{{--        </div>--}}
        <div class="list-disc bg-transparent" x-ref="editor"></div>
    </div>
</div>
