...
@if (! $onlyPostal)
    ...
    <div class="flex flex-col gap-1.5">
        ...
        <x-toggle
            ...
            x-bind:disabled="!$wire.edit || $wire.address.is_main_address"
            wire:model="address.is_main_address"
        />
        <x-toggle
            :label="__('Delivery Address')"
            x-bind:disabled="!$wire.edit || $wire.address.is_delivery_address"
            wire:model="address.is_delivery_address"
        />
        <x-toggle
            :label="__('Invoice Address')"
            x-bind:disabled="!$wire.edit || $wire.address.is_invoice_address"
    ...
    >
        <template
            x-for="(contactOption, index) in $wire.address.contact_options"
        >
