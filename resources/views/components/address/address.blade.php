...
<div class="table w-full table-auto gap-1.5" x-ref="address">
    @section('contact')
        ...
        <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-2">
            ...
            <div class="col-span-2 w-full">
                <x-checkbox
                    :label="__('Formal salutation')"
                    x-bind:disabled="!$wire.edit"
                    wire:model="address.has_formal_salutation"
                />
            </div>
        </div>
        <div
        ...
        <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-2">
            <x-label
                :label="__('Addition')"
                for="{{ md5('address.addition') }}"
            />
            <div class="col-span-2">
                <x-input
                    x-bind:readonly="!$wire.edit"
                    wire:model="address.addition"
                />
            </div>
        </div>
    @show
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-2">
                ...
                <div class="col-span-2">
                    ...
                    >
                        <x-slot:prefix>
                            <div
                                class="absolute inset-y-0 left-0 flex items-center p-0.5"
                            >
                                <x-button
        ...
        @section('contact-channels.phone_mobile')
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-2">
                <x-label
                    ...
                    for="{{ md5('address.phone_mobile') }}"
                />
                <div class="col-span-2">
                    <x-input
                        x-bind:readonly="!$wire.edit"
                        class="pl-12"
                        wire:model="address.phone_mobile"
                    >
                        <x-slot:prefix>
                            <div
                                class="absolute inset-y-0 left-0 flex items-center p-0.5"
        ...
        @if(! $onlyPostal)
            ...
            >
                <x-label
                    ...
                    for="{{ md5('address.advertising_state') }}"
                />
                <div class="col-span-2">
                    <x-flux::state
                        x-bind:class="!$wire.edit && 'pointer-events-none'"
    ...
    @if(! $onlyPostal)
        ...
        <div class="flex flex-col gap-1.5">
            @section('attributes.toggles')
                ...
                <x-toggle
                    ...
                    x-bind:disabled="
                        !$wire.edit || $wire.address.is_main_address
                    "
                    wire:model="address.is_main_address"
                />
                <x-toggle
                    :label="__('Delivery Address')"
                    x-bind:disabled="
                        !$wire.edit || $wire.address.is_delivery_address
                    "
                    wire:model="address.is_delivery_address"
                />
                <x-toggle
        ...
        @section('attributes.contact-options')
            ...
            >
                <template
                    x-for="
                        (contactOption, index) in $wire.address.contact_options
                    "
                >
                    <div class="flex items-center gap-1.5">
                        ...
                        <div x-transition x-cloak x-show="$wire.edit">
                            <x-button
                                ...
                                color="red"
                                x-on:click.prevent="
                                    $wire.address.contact_options.splice(
                                        index,
                                        1,
                                    )
                                "
                ...
                <div x-transition x-cloak x-show="$wire.edit">
                    <x-button
                        ...
                        color="indigo"
                        x-on:click.prevent="
                            $wire.address.contact_options.push({
                                type: 'email',
                            })
                        "
                        x-bind:disabled="!$wire.edit"
